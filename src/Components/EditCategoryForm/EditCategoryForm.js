  ...
  const getDataForEdit = async () => {
    ...
    try {
      const response = await axios.get(
        `https://ah-backend-djja.onrender.com/ah/api/v1/user/category/${storedId}`,
        {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (currentStep === 1) {
        ...
        await axios.patch(
          `https://ah-backend-djja.onrender.com/ah/api/v1/user/category/${storedId}/image`,
          formData,
          {
            headers: {
              authorization: `Bearer ${localStorage.getItem("authorization")}`,
        ...
        await axios.patch(
          `https://ah-backend-djja.onrender.com/ah/api/v1/user/category/${storedId}/docFile`,
          formData,
          {
            headers: {
